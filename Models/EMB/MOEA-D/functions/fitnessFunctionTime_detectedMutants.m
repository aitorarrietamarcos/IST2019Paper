function [out] = fitnessFunctionTime_detectedMutants(activationArray)
    ...
    [detectedMutantsArray, detectedMutantsP] = detectedMutants(activationArray);
    out(1) = time/total_time;
    out(2) = 1- detectedMutantsP;
    out(3) = detectedMutantsP;
end
