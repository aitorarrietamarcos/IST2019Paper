...
global system;
system = 'Twotanks_Model';
global data_objects;
[test_objects, data_objects] = cvload('BlackBoxAndWhiteBoxData/WhiteBoxCov_2017b');
open 'Twotanks_Model.slx'
fitness = {@(a) fitnessFunction_mcdc(a)};
FitnessName = {"Time/MCDC"};
...
writetable(results_table, 'GA_results_50.xlsx');
