...
MODEL     = CL_pi_testExecution
TARGET      = sfun
MODULE_SRCS   = c3_CL_pi_testExecution.c c4_CL_pi_testExecution.c
MODEL_SRC  = CL_pi_testExecution_sfun.c
MODEL_REG = CL_pi_testExecution_sfun_registry.c
MAKEFILE    = CL_pi_testExecution_sfun.mak
...
MLSLSF_INCLUDES = \
    ...
    /I "E:\Dropbox (MGEP)\BlackBoxTestSelection_R1\BlackBoxTestSelection\Models\ACEngine\BlackBoxData\slprj\_sfprj\CL_pi_testExecution\_self\sfun\src" 
...
OBJLIST_FILE = CL_pi_testExecution_sfun.mol
SFCLIB = 
AUX_LNK_OBJS =     
USER_LIBS = 
#--------------------------------- Rules --------------------------------------
