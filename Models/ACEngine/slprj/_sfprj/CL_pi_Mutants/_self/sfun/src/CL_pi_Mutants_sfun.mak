...
MODEL     = CL_pi_Mutants
TARGET      = sfun
MODULE_SRCS   = c1_CL_pi_Mutants.c
MODEL_SRC  = CL_pi_Mutants_sfun.c
MODEL_REG = CL_pi_Mutants_sfun_registry.c
MAKEFILE    = CL_pi_Mutants_sfun.mak
...
MLSLSF_INCLUDES = \
    ...
    /I "E:\Dropbox (MGEP)\JSS_Data_and_Models\CL_PI\Model\slprj\_sfprj\CL_pi_Mutants\_self\sfun\src" 
...
OBJLIST_FILE = CL_pi_Mutants_sfun.mol
SFCLIB = 
AUX_LNK_OBJS =     
USER_LIBS = 
#--------------------------------- Rules --------------------------------------
