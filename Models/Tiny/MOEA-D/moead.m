function [EP] = moead()
    ...
    T=min(max(T,2),15);
    %T = 20;%As in the case of the paper
...
%         else
%              pop(i).Position=zeros(1,TestSuiteSize);%randi([0 1],1,TestSuiteSize);
%         end
...
%             end
            y.Position=Crossover(p1.Position,p2.Position);%crossover done as in the original MOEA/D paper
